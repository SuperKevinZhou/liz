...
fn builtin_specs() -> Vec<ProviderSpec> {
    vec![
        ...
        spec(
            ...
            &[],
            ModelCapabilities::google_family(),
            &["CLI-backed Gemini provider variant."],
        ),
        spec(
        ...
        openai_compatible_spec("sap-ai-core", "SAP AI Core", "anthropic/claude-sonnet-4-20250514"),
        ...
        openai_compatible_spec("poe", "Poe", "anthropic/claude-sonnet-4-20250514"),
        ...
        openai_compatible_spec("zenmux", "ZenMux", "anthropic/claude-sonnet-4-20250514"),
    ]
}
